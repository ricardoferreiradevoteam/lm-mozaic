...
<template>
  <div class="main">
    <!-- Example using vue3 compoennts -->
    <MButton label="Default button 1" />
    <m-data-table v-bind="args" :source="sources" :style="styles" @row-click="onRowClick">
      <m-data-table-header :data-field-expr="'selected'"/>
        <m-data-table-header :caption="'Nom'" :data-field-expr="'name'" :allow-sorting="true" :sort-order="'desc'"/>
        <m-data-table-header :caption="'Stock'" :data-field-expr="'stock'" :allow-sorting="false"/>
        <m-data-table-header :caption="'Date de début'" :data-field-expr="'startDate'" :allow-sorting="true"/>
        <m-data-table-header :caption="'Date de fin'" :data-field-expr="'endDate'" :allow-sorting="true"/>
        <m-data-table-header :caption="'Statut'" :data-field-expr="'status.code'" :allow-sorting="true"/>
    </m-data-table>
  </div>
</template>
